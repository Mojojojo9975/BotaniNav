...
class IndoorMapWidget extends ConsumerStatefulWidget {
  ...
  /// Live user GPS position — rendered as a blue pulsing dot.
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterMap(
          ...
          children: [
            ...
            // ── 5. User location (blue pulsing dot) ─────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// User location dot — blue pulsing "you are here" indicator
// ─────────────────────────────────────────────────────────────────────────────

class _UserLocationDot extends StatelessWidget {
  const _UserLocationDot({required this.pulseValue});
  final double pulseValue;

  @override
  Widget build(BuildContext context) {
    // Outer ring scales between 0.6x and 1.0x, fading as it expands.
    final outerSize = 32 + (pulseValue - 0.6) * 80; // 32–64 px
    final outerOpacity = (1.0 - pulseValue).clamp(0.0, 0.35);
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: const Color(0xFF4285F4).withOpacity(outerOpacity),
            border: Border.all(
              color: const Color(0xFF4285F4).withOpacity(outerOpacity * 0.8),
              width: 1,
            ),
          ),
        ),
